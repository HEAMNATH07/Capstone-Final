...
public class WorkspaceService {
    ...
    public List<Workspace> getWorkspacesByFloorAndRoom(String floor, String room) {
        return workspaceRepository.findByFloorAndRoom(floor, room);
    }

    public List<Workspace> getAvailableWorkspaces() {
        return workspaceRepository.findByIsBooked(false);
    }

    public List<Workspace> getWorkspacesByBookingStatusAndProject(boolean isBooked, String projectId) {
        return workspaceRepository.findByIsBookedAndProjectId(isBooked, projectId);
    }
    ...
    public List<Workspace> getFloorAndRoomByProjectId(String projectId) {
        return workspaceRepository.findFloorAndRoomByProjectId(projectId);
    }
    public List<String> getSeatByFloorAndRoom(String floor, String room) {
        List<Workspace> workspaces = workspaceRepository.findByFloorAndRoom(floor, room);

        // Extract seat numbers from the retrieved workspaces
        return workspaces.stream()
                .map(Workspace::getSeatNumber)
                .toList();
    }
